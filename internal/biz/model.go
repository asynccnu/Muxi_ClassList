...
type ClassInfo struct {
	...
	Day          int64   `gorm:"column:day;uniqueIndex:info_idx;not null" json:"day"`               //星期几
	Teacher      string  `gorm:"column:teacher;uniqueIndex:info_idx;not null" json:"teacher"`       //任课教师
	Where        string  `gorm:"column:where;uniqueIndex:info_idx;not null" json:"where"`           //上课地点
	ClassWhen    string  `gorm:"column:class_when;uniqueIndex:info_idx;not null" json:"class_when"` //上课是第几节（如1-2,3-4）
	WeekDuration string  `gorm:"column:week_duration;not null" json:"week_duration"`                //上课的周数
	Classname    string  `gorm:"column:class_name;uniqueIndex:info_idx;not null" json:"classname"`  //课程名称
	Credit       float64 `gorm:"column:credit;default:1.0" json:"credit"`                           //学分
	Weeks        int64   `gorm:"column:weeks;uniqueIndex:info_idx;not null" json:"weeks"`           //哪些周
	Semester     string  `gorm:"column:semester;uniqueIndex:info_idx;not null" json:"semester"`     //学期
	Year         string  `gorm:"column:year;uniqueIndex:info_idx;not null" json:"year"`             //学年
}
type StudentCourse struct {
	ID              string `gorm:"primaryKey;column:id" json:"id"`
	StuID           string `gorm:"column:stu_id;uniqueIndex:sc_idx;not null" json:"stu_id"`         //学号
	ClaID           string `gorm:"column:cla_id;uniqueIndex:sc_idx;not null" json:"cla_id"`         //课程ID
	Year            string `gorm:"column:year;uniqueIndex:sc_idx;not null" json:"year"`             //学年
	Semester        string `gorm:"column:semester;uniqueIndex:sc_idx;not null" json:"semester"`     //学期
