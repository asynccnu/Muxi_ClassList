...
var (
	...
	ErrRecycleBinDoNotHaveIt = errors.New(307, v1.ErrorReason_RECYCLEBINDONOTHAVETHECLASS.String(), "回收站中不存在该课程")
	ErrRecover               = errors.New(308, v1.ErrorReason_RECOVERFAILED.String(), "恢复课程失败")
)
